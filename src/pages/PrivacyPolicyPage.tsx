          ...
          <div className="space-y-8 text-sm leading-relaxed text-slate-700">
            ...
            <section>
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 text-xs text-emerald-900">
                <strong>การใช้สิทธิหรือสอบถามเพิ่มเติม:</strong> กรุณาติดต่อผู้ควบคุมข้อมูลส่วนบุคคล หอพักภัทร์ลดา อพาร์ตเมนต์ ผ่านอีเมล: <code className="font-mono bg-white px-1.5 py-0.5 rounded border">chetnarak2531@gmail.com</code> หรือโทรศัพท์ 087-188-9122, 091-851-7221
              </div>
            </section>
          </div>
        </div>
