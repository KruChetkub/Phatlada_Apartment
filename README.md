# DormPlus — Markdown Spec Pack

ชุดไฟล์ `.md` สำหรับสร้างหน้า Dashboard ระบบจัดการหอพัก **DormPlus** ด้วย AI coding agent (Claude Code, Codex, Cursor ฯลฯ) หรือทีมนักพัฒนา
...
- Tech stack ใน SPEC.md เป็นข้อเสนอ เปลี่ยนได้ตามทีม
